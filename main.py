...
btn_add = tk.Button(root, text='(', command=lambda: add_to_cal('('), width=5, font=('Arial',14))
...
btn_sub = tk.Button(root, text='-', command=lambda: add_to_cal('-'), width=5, font=('Arial',14))
...
btn_equal = tk.Button(root, text='=', command=evaluate_cal, width=12, font=('Arial',14))
